...
func (t *StateTest) Run(subtest StateSubtest) error {
	...
	if len(t.json.Logs) > 0 {
		if err := checkLogs(statedb.Logs(), t.json.Logs); err != nil {
			return err
		}
	}
	...
	fmt.Printf("storage[0] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), common.HexToHash("0x0")))
	fmt.Printf("storage[1] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), common.HexToHash("0x1")))
	fmt.Printf("storage[4] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), common.HexToHash("0x4")))
	...
	fmt.Printf("storage[2] at the problematic address b0 %v\n", statedb.GetState(common.HexToAddress("0xb000000000000000000000000000000000000000"), common.HexToHash("0x2")))
	fmt.Printf("storage[3] at the problematic address b0 %v\n", statedb.GetState(common.HexToAddress("0xb000000000000000000000000000000000000000"), common.HexToHash("0x3")))
...
func checkLogs(have []*types.Log, want []stLog) error {
	...
	for i := range have {
		...
		if !reflect.DeepEqual(have[i].Topics, want[i].Topics) {
			return fmt.Errorf("log topics %d: got %x, want %x", i, have[i].Topics, want[i].Topics)
		}
