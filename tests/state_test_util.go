...
func (t *StateTest) Run(subtest StateSubtest) error {
	...
	fmt.Printf("storage[0] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), 0))
	fmt.Printf("storage[1] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), 1))
	fmt.Printf("storage[4] at the problematic address 3e %v\n", statedb.GetState(common.HexToAddress("0x3e180b1862f9d158abb5e519a6d8605540c23682"), 4))
	...
	fmt.Printf("storage[2] at the problematic address b0 %v\n", statedb.GetState(common.HexToAddress("0xb000000000000000000000000000000000000000"), 2))
	fmt.Printf("storage[3] at the problematic address b0 %v\n", statedb.GetState(common.HexToAddress("0xb000000000000000000000000000000000000000"), 3))
